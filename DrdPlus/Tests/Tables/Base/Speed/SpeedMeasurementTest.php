<?php
namespace DrdPlus\Tests\Tables\Base\Speed;

use DrdPlus\Tables\Base\Speed\SpeedMeasurement;
...
class SpeedMeasurementTest extends AbstractTestOfMeasurement
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Tables\Base\Speed\Exceptions\KilometersHaveToBeLesserThanKilometers
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Tables\Base\Speed\Exceptions\MetersHaveToBeGreaterThanKilometers
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Tables\Base\Speed\Exceptions\MissingConversion
     */
