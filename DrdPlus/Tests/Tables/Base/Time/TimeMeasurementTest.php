<?php
namespace DrdPlus\Tests\Tables\Base\Time;

use DrdPlus\Tables\Base\Time\Exceptions\LaterDefinedValueShouldBeLesser;
use DrdPlus\Tables\Base\Time\Exceptions\PreviouslyDefinedUnitShouldBeGreater;
use DrdPlus\Tables\Base\Time\TimeMeasurement;
