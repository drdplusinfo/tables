<?php
namespace DrdPlus\Tests\Tables\BonusBased\Distance;

use DrdPlus\Tables\BonusBased\Distance\DistanceMeasurement;
...
class DistanceMeasurementTest extends AbstractTestOfMeasurement
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Tables\BonusBased\Distance\Exceptions\IncorrectRatio
     */
