...
use DrdPlus\Tables\Time\TimeMeasurement;
    ...
    public function I_can_not_add_greater_value_of_later_defined_unit()
    {
        ...
        while ($units) {
            ...
            foreach ($units as $greaterUnit) {
                ...
                } catch (\DrdPlus\Tables\Time\Exceptions\LaterDefinedValueShouldBeLesser $exception) {
                    $catches++;
                }
            }
    ...
    public function I_can_not_add_lesser_value_of_previously_defined_unit()
    {
        ...
        while ($units) {
            ...
            foreach ($units as $lesserUnit) {
                ...
                } catch (\DrdPlus\Tables\Time\Exceptions\PreviouslyDefinedUnitShouldBeGreater $exception) {
                    $catches++;
                }
            }
            $this->assertSame(count($units), $catches);
